...
// Define the seat matrix (adjust the rows and columns as needed)
$rows = 5;
$columns = 8;
$seatMatrix = array();
...
for ($i = 1; $i <= $rows; $i++) {
    ...
    for ($j = 1; $j <= $columns; $j++) {
        $seatno = "$i-$j";
        echo "<input type='checkbox' name='selected_seats[]' value='$seatno' id='$seatno'>";
        echo "<label for='$seatno'>$seatno</label>";
    }
    echo "</div>";
}
...
?>
                    ...
                    <button href="verify.php" type="submit" value="save" name="submit" class="form-btn">Book a seat</button>
